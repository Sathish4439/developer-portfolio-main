...
const projects = [
  ...
  },
  {
    ...
    description: "A managed cloud SaaS platform and real-time API that transforms any Android smartphone with an active SIM card into an API-addressable 2-way SMS gateway, eliminating high carrier surcharges.",
    accent: "#E8A33D",
