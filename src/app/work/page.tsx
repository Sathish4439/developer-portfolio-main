...
const projects = [
  // ─────────────── 2026 PROJECTS ───────────────
  {
    ...
    category: "Cloud & SaaS",
    year: "2026",
    tags: ["Node.js", "Express 5", "WebSocket", "BullMQ", "React 19", "Kotlin", "Prisma", "PostgreSQL"],
    description: "A high-throughput cloud control plane and real-time WebSocket gateway transforming commodity Android devices with domestic SIM cards into programmable, API-addressable 2-way SMS telecommunication infrastructure.",
    accent: "#F59E0B",
    metrics: "Real-Time WebSocket Gateway",
    caseStudyUrl: "/work/flatsms-sms-gateway",
  },
  {
    id: "mayiliragu-lms",
  ...
  },
  {
    ...
    category: "Full Stack",
    year: "2026",
    tags: ["Flutter", "Node.js", "Socket.io", "Prisma", "PostgreSQL", "Redis", "Firebase", "Razorpay"],
    description: "A real-time food delivery platform with 3 Flutter apps (customer, restaurant, rider) and a Node.js backend — featuring live GPS tracking via Socket.io, Razorpay payments, Redis queuing, and Google Maps route rendering. Live on Google Play.",
    accent: "#e11d48",
  ...
  // ─────────────── 2025 PROJECTS ───────────────
  {
    ...
    category: "Full Stack",
    year: "2025",
    tags: ["Flutter", "Node.js", "GetX", "Prisma", "PostgreSQL", "AWS S3", "QR Scan", "PDF Kit"],
    description: "A multi-role automotive supply chain ERP app automating employee check-ins, product QR scanning, daily payout ledgers, and bulk inventory reports. Engineered with Flutter/GetX, Express 5, and Prisma ORM.",
    accent: "#a855f7",
